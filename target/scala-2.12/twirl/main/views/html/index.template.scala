                                    ...
                                    """),format.raw/*151.37*/("""<div class="card border-primary mb-3" style="max-width: 27rem;">
                                            ...
                                            <div class="card-body">
                                                <div style="clear: both">
                                                    ...
                                                    <p style="float: center">"""),_display_(/*158.79*/f/*158.80*/.testdate()),format.raw/*158.91*/("""</p>
                                                </div>
                                                <hr />
