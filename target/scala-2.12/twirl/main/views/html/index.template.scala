                                    ...
                                    """),format.raw/*154.37*/("""<div class="card border-dark mb-3" style="max-width: 27rem;">
                                            ...
                                            <div class="card-body">
                                                <div style="clear: both">
                                                    ...
                                                    <p style="float: center">"""),_display_(/*160.79*/f/*160.80*/.getCat().getName()),format.raw/*160.99*/("""</p>
                                                    
                                                </div>
                                                <hr />
                                            <a href=""""),_display_(/*164.55*/routes/*164.61*/.HomeController.delete(f.getId())),format.raw/*164.94*/("""" class="btn btn-outline-secondary btn-sm">
                                                <i class="far  fa-trash-alt"></i></a>
                                                </a>

                                                 <a href=""""),_display_(/*168.60*/routes/*168.66*/.HomeController.changeStatus(f.getId())),format.raw/*168.105*/("""" class="btn btn-outline-secondary btn-sm">
                                                <i class="fas fa-check"></i></a>

                                                <a href=""""),_display_(/*171.59*/routes/*171.65*/.HomeController.edit(f.getId())),format.raw/*171.96*/("""" class="btn btn-outline-secondary btn-sm">
                                                    <i class="fas fa-edit"></i></a>
                                        </div>
                                    </div>
