                    ...
                    <center>
                     <h3>Due in future</h3>
                      ...
                      """),_display_(/*143.24*/for(f <- items) yield /*143.39*/{_display_(Seq[Any](format.raw/*143.40*/("""
                        ...
                        """),_display_(/*146.26*/if(f.isToday() == false)/*146.50*/{_display_(Seq[Any](format.raw/*146.51*/("""
                                 ...
                                 """),_display_(/*150.35*/if(f.getCompleted()== compare)/*150.65*/ {_display_(Seq[Any](format.raw/*150.67*/("""
                                    """),format.raw/*151.37*/("""<div class="card border-primary mb-3" style="max-width: 27rem;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <hr />
                                            <a href=""""),_display_(/*160.55*/routes/*160.61*/.HomeController.delete(f.getId())),format.raw/*160.94*/("""" class="btn btn-outline-secondary btn-sm">
                                                <i class="far  fa-trash-alt"></i></a>
                                                </a>

                                                 <a href=""""),_display_(/*164.60*/routes/*164.66*/.HomeController.changeStatus(f.getId())),format.raw/*164.105*/("""" class="btn btn-outline-secondary btn-sm">
                                                <i class="fas fa-check"></i></a>

                                                <a href=""""),_display_(/*167.59*/routes/*167.65*/.HomeController.edit(f.getId())),format.raw/*167.96*/("""" class="btn btn-outline-secondary btn-sm">
                                                    <i class="fas fa-edit"></i></a>
                                        </div>
                                    </div>
