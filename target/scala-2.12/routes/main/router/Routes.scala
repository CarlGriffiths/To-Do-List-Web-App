...
class Routes(
  ...
  // @LINE:17
  private[this] lazy val controllers_HomeController_submitRegister11_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("submitRegister")))
  )
  private[this] lazy val controllers_HomeController_submitRegister11_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:17
    case controllers_HomeController_submitRegister11_route(params@_) =>
      call { 
        controllers_HomeController_submitRegister11_invoker.call(HomeController_0.submitRegister)
      }
